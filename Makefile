...
help:
	...
	@echo "The path to files should be container_NVDLA_RTL/NVDLA/outdir/nv_full/vmod/"
	...
	@echo "examples..."	
	@echo "make compile TESTNAME=<name of test> WAVES=<1 o 0, depending if we want to see waves or not>"	
	@echo "make compile TESTNAME=conv_8x8_fc_int16 WAVES=1"
	@echo "make compile TESTNAME=conv_8x8_fc_int16 WAVES=0"
	@echo "---------------------------------------------------------------------------"	
	@echo ""	
	@echo "---------------------------------------------------------------------------"
...
results:
	...
	@#Borro y creo un MAC_results_EXPECTED.txt vacio
	@#[ -f /results_testbench/MAC_results_EXPECTED.txt ] && rm /results_testbench/MAC_results_EXPECTED.txt || echo "MAC_results_EXPECTED.txt has been deleted before :)"
