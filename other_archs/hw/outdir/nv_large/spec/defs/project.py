PROJVAR = {
    ...
    'NVDLA_WEIGHT_COMPRESSION_ENABLE':True,
    ...
    'NVDLA_PRIMARY_MEMIF_LATENCY':1200,
    'NVDLA_SECONDARY_MEMIF_LATENCY':128,
    'NVDLA_PRIMARY_MEMIF_MAX_BURST_LENGTH':1,
    'NVDLA_PRIMARY_MEMIF_WIDTH':512,
    'NVDLA_SECONDARY_MEMIF_MAX_BURST_LENGTH':4,
    'NVDLA_SECONDARY_MEMIF_WIDTH':512,
    'NVDLA_MEM_ADDRESS_WIDTH':64,
    'NVDLA_MEMIF_WIDTH':512,
    'NVDLA_DMA_RD_SIZE':15,
    'NVDLA_DMA_WR_SIZE':13,
    'NVDLA_DMA_MASK_BIT':2,
    'NVDLA_DMA_RD_RSP':514,
    'NVDLA_DMA_WR_REQ':515,
    'NVDLA_DMA_WR_CMD':78,
    'NVDLA_DMA_RD_REQ':79,
    'NVDLA_MEMORY_ATOMIC_LOG2':5,
    'NVDLA_PRIMARY_MEMIF_WIDTH_LOG2':6,
    'NVDLA_SECONDARY_MEMIF_WIDTH_LOG2':6,
    'NVDLA_NUM_DMA_READ_CLIENTS':10,
    'NVDLA_NUM_DMA_WRITE_CLIENTS':5,
